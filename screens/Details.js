...
import {CIrcleButton, RectButton, SubInfo, FocusedStatusBar, DetailsDesc, DetailsBid, CircleButton} from '../components';
...
const Details = ({route, navigation}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{width: '100%', position: 'absolute', bottom: 0, paddingVertical: SIZES.font, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(225, 225, 225, 0.5)', zIndex: 1}}>
